...
WelcomeEmail.PreviewProps = {
  ...
  messages: {
    Mail: {
      ...
      welcome: {
        greeting: "Hi {name},",
        title: "Welcome to VideoAI!",
        body: "Thank you for joining VideoAI! We're thrilled to have you on board.",
        features: "With VideoAI, you can:",
        featuresList: {
          generate: "Generate stunning AI videos in minutes",
          models: "Create with our Seedance 2.0 powered workflow",
