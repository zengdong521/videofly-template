            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
                {locale === "zh" ? (
                    <>
                        ...
                        <h2>1. 引言</h2>
                        <p>
                            VideoAI（"我们"）非常重视您的隐私。本隐私政策说明了当您使用我们的服务时，我们如何收集、使用、披露和保护您的信息。
                        </p>
                    ...
                    <>
                        ...
                        <p>
                            VideoAI ("we" or "us") values your privacy. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use our services.
                        </p>
